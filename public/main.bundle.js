...
module.exports = "<div *ngIf=\"!chart\">Loading chart data...</div>\n<div [chart]=\"chart\"></div>"
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        console.log(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].db);
        ...
        this.http.get(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].db).subscribe(function (data) {
            var _temps = [];
            var _stamps = [];
            var _locations = [];
            for (var item in data) {
                _temps.push(Number((data[item].temperature).toFixed(1)));
                _stamps.push(__WEBPACK_IMPORTED_MODULE_3_moment__(data[item].timestamp).format('dd HH:mm'));
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_3_angular_highcharts__["b" /* ChartModule */],
            ],
            providers: [],
...
var environment = {
    production: false,
    berend: 'dit is dev',
    // db: 'http://localhost:4000/tempmon/data',
    db: '../tempmon/data'
};
